...
class InsuranceData(BaseModel):
    ...
    income_lpa: Annotated[float, Field(...,gt=0, description="Income in LPA must be a positive number")]
    smoker: Annotated[bool, Field(...,description="True if the person is a smoker, False otherwise")]
